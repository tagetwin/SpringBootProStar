...
<html>
  ...
  <body>
    <nav class="navbar navbar-expand-md bg-dark navbar-dark">
      ...
      <form class="form-inline" action="/board/search">
        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-header">
              <a href="#"><img class="otherProfile" src="/img/b1.jpg"/></a
              >팔로우중인 유저네임
            </div>
            <div class="card-body">
              <img src="/img/본문.png" />
        ...
        <div class="col-md-4">
          <div class="row">
            <div class="col-2 mb-3 text-center mt-4">
              <a><img id="myProfile" src="img/b1.jpg" alt=""/></a>
            </div>
            <div class="col-10">
              ...
              <div class="p">
                ...
                atque quas error, ea earum modi numquam dolore reiciendis
                corporis culpa!
              </div>
            </div>
          </div>
